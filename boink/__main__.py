...
from boink.cli import main, VERBOSITY
from boink.boink import boink, DEFAULT_CONFIG
...
if not args["content_paths"]:
    del args["content_paths"]
if not args["log_level"]:
    del args["log_level"]
if not args["dryrun"]:
    del args["dryrun"]

sys.exit(main(lambda cfg: boink(cfg=cfg), args, cfg, f"Starting {APP_NAME}..."))
